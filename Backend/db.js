// db.js 
// // Sets up a local SQLite database file and creates the users table
//  // if it doesn't already exist. better-sqlite3 is synchronous, which
//  // is fine (even nice) for a small app like this — no callback/await // juggling for simple queries. 
